...
local backgroundColor = Color3.fromRGB(11, 16, 22)
...
local defaultColor = Color3.fromRGB(230, 237, 243)
local commentColor = Color3.fromRGB(101, 113, 128)
local lineNumberColor = commentColor
local genericColor = Color3.fromRGB(146, 158, 173)
...
function Highlight:init(frame)
    if typeof(frame) == "Instance" and frame:IsA("Frame") then
        ...
        scrollingFrame.ScrollBarImageColor3 = Color3.fromRGB(70, 81, 94)
